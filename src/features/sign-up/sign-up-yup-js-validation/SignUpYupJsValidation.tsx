...
const SignUpYupJsValidation = () => {
    ...
    const {
        ...
        loading: userLoading,
        error: userError,
    } = useApiPost<IUser>(`${JSON_SERVER_BASE_URL}/users`)
    ...
    return (
        <React.Fragment>
            <SignUpTemplate title="Sign up (yup + JSON Server)">
...
export default SignUpYupJsValidation
